...
const initWebRoutes = (app) => {
	...
	const { createABookingByDoctorIdCtrl, getPatientTokenForConfirmCtrl } = patientCtrls;
	...
	appRouters.post(createABookingByDoctorIdApi, createABookingByDoctorIdCtrl);
